...
namespace BUILTIN 
{
    ...
    static int START_NEW_SCRIPT(char* scriptName, int stackSize) { return Native::Invoke<int, char*, int>(0xE81651AD79516E48, scriptName, stackSize); } 
    static int START_NEW_SCRIPT_WITH_ARGS(char* scriptName, Any* args, int argCount, int stackSize) { return Native::Invoke<int, char*, Any*, int, int>(0xB8BA7F44DF1575E1, scriptName, args, argCount, stackSize); } 
...
namespace AUDIO 
{
    ...
    static void ADD_PED_TO_CONVERSATION(int pedIndex, Ped ped, char* name) { return Native::Invoke<void, int, Ped, char*>(0x95D9F4BC443956E7, pedIndex, ped, name); } 
    ...
    static void RELEASE_NAMED_SCRIPT_AUDIO_BANK(char* audioBank) { return Native::Invoke<void, char*>(0x77ED170667F50170, audioBank); } 
    ...
    static void SET_AMBIENT_VOICE_NAME(Ped ped, char* name) { return Native::Invoke<void, Ped, char*>(0x6C8065A3B780185B, ped, name); } 
    ...
    static BOOL _CAN_PED_SPEAK(Ped ped, char* speechName, BOOL unk) { return Native::Invoke<BOOL, Ped, char*, BOOL>(0x49B99BF3FDA89A7A, ped, speechName, unk); } 
    ...
    static void SET_STATIC_EMITTER_ENABLED(char* emitterName, BOOL toggle) { return Native::Invoke<void, char*, BOOL>(0x399D2D3B33F1B8EB, emitterName, toggle); } 
    ...
    static void CLEAR_AMBIENT_ZONE_STATE(char* zoneName, BOOL p1) { return Native::Invoke<void, char*, BOOL>(0x218DD44AAAC964FF, zoneName, p1); } 
    static void SET_AMBIENT_ZONE_LIST_STATE(char* p0, BOOL p1, BOOL p2) { return Native::Invoke<void, char*, BOOL, BOOL>(0x9748FA4DE50CCE3E, p0, p1, p2); } 
    static void CLEAR_AMBIENT_ZONE_LIST_STATE(Any* p0, BOOL p1) { return Native::Invoke<void, Any*, BOOL>(0x120C48C614909FA4, p0, p1); } 
    static void SET_AMBIENT_ZONE_STATE_PERSISTENT(char* ambientZone, BOOL p1, BOOL p2) { return Native::Invoke<void, char*, BOOL, BOOL>(0x1D6650420CEC9D3B, ambientZone, p1, p2); } 
    static void SET_AMBIENT_ZONE_LIST_STATE_PERSISTENT(char* ambientZone, BOOL p1, BOOL p2) { return Native::Invoke<void, char*, BOOL, BOOL>(0xF3638DAE8C4045E1, ambientZone, p1, p2); } 
    ...
    static BOOL LOAD_STREAM(char* streamName, char* soundSet) { return Native::Invoke<BOOL, char*, char*>(0x1F1F957154EC51DF, streamName, soundSet); } 
    ...
    static void _FORCE_VEHICLE_ENGINE_AUDIO(Vehicle vehicle, char* audioName) { return Native::Invoke<void, Vehicle, char*>(0x4F0C413926060B38, vehicle, audioName); } 
    ...
    static BOOL START_AUDIO_SCENE(char* scene) { return Native::Invoke<BOOL, char*>(0x013A80FC08F6E4F2, scene); } 
    static Any _0xDC2F83A0612CA34D(Any p0) { return Native::Invoke<Any, Any>(0xDC2F83A0612CA34D, p0); } 
    static void STOP_AUDIO_SCENE(char* scene) { return Native::Invoke<void, char*>(0xDFE8422B3B94E688, scene); } 
    ...
    static BOOL IS_AUDIO_SCENE_ACTIVE(char* scene) { return Native::Invoke<BOOL, char*>(0xB65B60556E2A9225, scene); } 
    static void SET_AUDIO_SCENE_VARIABLE(char* scene, char* variable, float value) { return Native::Invoke<void, char*, char*, float>(0xEF21A9EF089A2668, scene, variable, value); } 
    ...
    static BOOL PREPARE_MUSIC_EVENT(char* eventName) { return Native::Invoke<BOOL, char*>(0x1E5185B72EF5158A, eventName); } 
    static BOOL CANCEL_MUSIC_EVENT(char* eventName) { return Native::Invoke<BOOL, char*>(0x5B17A90291133DA5, eventName); } 
    static BOOL TRIGGER_MUSIC_EVENT(char* eventName) { return Native::Invoke<BOOL, char*>(0x706D57B0F50DA710, eventName); } 
    ...
    static void SET_AUDIO_FLAG(char* flagName, BOOL toggle) { return Native::Invoke<void, char*, BOOL>(0xB9EFD5C25018725A, flagName, toggle); } 
...
namespace CAM 
{
    ...
    static Cam CREATE_CAM(char* camName, BOOL unk) { return Native::Invoke<Cam, char*, BOOL>(0xE72CDBA7F0A02DD6, camName, unk); } 
    static Cam CREATE_CAM_WITH_PARAMS(char* camName, float posX, float posY, float posZ, float rotX, float rotY, float rotZ, float fov, BOOL p8, int p9) { return Native::Invoke<Cam, char*, float, float, float, float, float, float, float, BOOL, int>(0x40C23491CE83708E, camName, posX, posY, posZ, rotX, rotY, rotZ, fov, p8, p9); } 
    ...
    static void SHAKE_CAM(Cam cam, char* type, float amplitude) { return Native::Invoke<void, Cam, char*, float>(0xF9A7BCF5D050D4E7, cam, type, amplitude); } 
    ...
    static BOOL PLAY_CAM_ANIM(Cam cam, char* animName, char* animDictionary, float x, float y, float z, float xRot, float yRot, float zRot, BOOL p9, int p10) { return Native::Invoke<BOOL, Cam, char*, char*, float, float, float, float, float, float, BOOL, int>(0xA263DDF694D563F6, cam, animName, animDictionary, x, y, z, xRot, yRot, zRot, p9, p10); } 
    ...
    static void SHAKE_GAMEPLAY_CAM(char* shakeName, float intensity) { return Native::Invoke<void, char*, float>(0xD9B31B4650520529, shakeName, intensity); } 
...
namespace DATAFILE 
{
    ...
    static char* DATAFILE_GET_FILE_DICT() { return Native::Invoke<char*>(0xBBD8CF823CAE557C); } 
    ...
    static char* _OBJECT_VALUE_GET_STRING() { return Native::Invoke<char*>(0xE37B38C0B4E95DFA); } 
    ...
    static char* _ARRAY_VALUE_GET_STRING() { return Native::Invoke<char*>(0xB6790A8FF80F889F); } 
...
namespace DECORATOR 
{
    static BOOL DECOR_SET_BOOL(Entity entity, char* propertyName, BOOL value) { return Native::Invoke<BOOL, Entity, char*, BOOL>(0xFE26E4609B1C3772, entity, propertyName, value); } 
    static Any DECOR_SET_FLOAT(Any p0, Any p1, Any p2) { return Native::Invoke<Any, Any, Any, Any>(0x238F8B0C1C7FE834, p0, p1, p2); } 
    static BOOL DECOR_SET_INT(Entity entity, char* propertyName, int value) { return Native::Invoke<BOOL, Entity, char*, int>(0xE88F4D7F52A6090F, entity, propertyName, value); } 
    ...
    static BOOL DECOR_GET_BOOL(Entity entity, char* propertyName) { return Native::Invoke<BOOL, Entity, char*>(0xDEF3F1B071ABB197, entity, propertyName); } 
    static Any DECOR_GET_FLOAT(Any p0, Any p1) { return Native::Invoke<Any, Any, Any>(0xE5FF70CD842CA9D4, p0, p1); } 
    static int DECOR_GET_INT(Entity entity, char* propertyName) { return Native::Invoke<int, Entity, char*>(0x44DB62727762FD9B, entity, propertyName); } 
    static Any _0xB1682B2443F0540B() { return Native::Invoke<Any>(0xB1682B2443F0540B); } 
    static BOOL DECOR_EXIST_ON(Entity entity, char* propertyName) { return Native::Invoke<BOOL, Entity, char*>(0xD9D1CDBF3464DCDF, entity, propertyName); } 
    static BOOL DECOR_REMOVE(Entity entity, char* propertyName) { return Native::Invoke<BOOL, Entity, char*>(0x2BA7F5877A088A1D, entity, propertyName); } 
    static Any _0x88942780E0ADEA42(Any p0) { return Native::Invoke<Any, Any>(0x88942780E0ADEA42, p0); } 
    static void DECOR_REGISTER(char* propertyName, int type) { return Native::Invoke<void, char*, int>(0x0B253D644E3C36B3, propertyName, type); } 
...
namespace ENTITY 
{
    ...
    static BOOL IS_ENTITY_PLAYING_ANIM(Entity entity, char* animDict, char* animName, int taskFlag) { return Native::Invoke<BOOL, Entity, char*, char*, int>(0xDEE49D5CA6C49148, entity, animDict, animName, taskFlag); } 
    ...
    static int GET_ENTITY_BONE_INDEX_BY_NAME(Entity entity, char* boneName) { return Native::Invoke<int, Entity, char*>(0xBACA8FE9C76C124E, entity, boneName); } 
    ...
    static BOOL FIND_ANIM_EVENT_PHASE(char* animDictionary, char* animName, char* p2, Any* p3, Any* p4) { return Native::Invoke<BOOL, char*, char*, char*, Any*, Any*>(0x42718CC559BD7776, animDictionary, animName, p2, p3, p4); } 
    ...
    static BOOL HAS_ENTITY_ANIM_FINISHED(Entity entity, char* animDict, char* animName, int p3) { return Native::Invoke<BOOL, Entity, char*, char*, int>(0xAEB40615337EF1E3, entity, animDict, animName, p3); } 
    static BOOL PLAY_ENTITY_ANIM(Entity entity, char* animName, char* animDict, float p3, BOOL loop, BOOL stayInAnim, BOOL p6, float delta, Any bitset) { return Native::Invoke<BOOL, Entity, char*, char*, float, BOOL, BOOL, BOOL, float, Any>(0xDC6D22FAB76D4874, entity, animName, animDict, p3, loop, stayInAnim, p6, delta, bitset); } 
    ...
    static Any STOP_ENTITY_ANIM(Entity entity, char* animation, char* animGroup, float p3) { return Native::Invoke<Any, Entity, char*, char*, float>(0x786591D986DE9159, entity, animation, animGroup, p3); } 
...
namespace GRAPHICS 
{
    ...
    static void SET_PARTICLE_FX_LOOPED_EVOLUTION(int ptfxHandle, char* propertyName, float amount, BOOL Id) { return Native::Invoke<void, int, char*, float, BOOL>(0x3674F389B0FACD80, ptfxHandle, propertyName, amount, Id); } 
    ...
    static void USE_PARTICLE_FX_ASSET(char* name) { return Native::Invoke<void, char*>(0xA10DB07FC234DD12, name); } 
    ...
    static void SET_TIMECYCLE_MODIFIER(char* modifierName) { return Native::Invoke<void, char*>(0xFA08722A5EA82DA7, modifierName); } 
    static void SET_TIMECYCLE_MODIFIER_STRENGTH(float strength) { return Native::Invoke<void, float>(0xFDB74C9CC54C3F37, strength); } 
    static void SET_TRANSITION_TIMECYCLE_MODIFIER(char* modifierName, float transition) { return Native::Invoke<void, char*, float>(0xFF927A09F481D80C, modifierName, transition); } 
    ...
    static void SET_TV_CHANNEL_PLAYLIST(int channel, char* playlist, BOOL fromBeginning) { return Native::Invoke<void, int, char*, BOOL>(0xDEC6B25F5DC8925B, channel, playlist, fromBeginning); } 
    ...
    static void ANIMPOSTFX_STOP(char* effectName) { return Native::Invoke<void, char*>(0xB4FD7446BAB2F394, effectName); } 
    ...
    static BOOL ANIMPOSTFX_IS_RUNNING(char* effectName) { return Native::Invoke<BOOL, char*>(0x4A123E85D7C4CA0B, effectName); } 
...
namespace HUD 
{
    ...
    static void _DRAW_TEXT(Any text, float xPos, float yPos) { return Native::Invoke<void, Any, float, float>(0xD79334A4BB99BAD1, text, xPos, yPos); } 
    static char* _GET_TEXT_SUBSTRING() { return Native::Invoke<char*>(0x9D7E12EC6A1EE4E5); } 
    static char* _GET_LABEL_TEXT(char* labelName) { return Native::Invoke<char*, char*>(0xCFEDCCAD3C5BA90D, labelName); } 
    ...
    static BOOL DOES_TEXT_LABEL_EXIST(char* gxt) { return Native::Invoke<BOOL, char*>(0x73C258C68D6F55B6, gxt); } 
    static const char* _GET_LABEL_TEXT_2(const char* label) { return Native::Invoke<const char*, const char*>(0x3429670F9B9EF2D3, label); } 
    ...
    static int GET_LENGTH_OF_LITERAL_STRING(char* string) { return Native::Invoke<int, char*>(0x481FBF588B0B76DB, string); } 
    ...
    static BOOL REGISTER_NAMED_RENDERTARGET(char* p0, BOOL p1) { return Native::Invoke<BOOL, char*, BOOL>(0x98AF2BB6F62BD588, p0, p1); } 
    static BOOL IS_NAMED_RENDERTARGET_REGISTERED(char* p0) { return Native::Invoke<BOOL, char*>(0x3EE32F7964C40FE6, p0); } 
    ...
    static Any GET_NAMED_RENDERTARGET_RENDER_ID(char* p0) { return Native::Invoke<Any, char*>(0xB6762A85EE29AA60, p0); } 
    ...
    static void SET_MISSION_NAME(BOOL p0, char* name) { return Native::Invoke<void, BOOL, char*>(0x402669A4BDAA72DA, p0, name); } 
...
namespace INTERIOR 
{
    ...
    static int GET_INTERIOR_AT_COORDS_WITH_TYPE(float x, float y, float z, char* interiorType) { return Native::Invoke<int, float, float, float, char*>(0xAAD6170AA33B13C0, x, y, z, interiorType); } 
...
namespace MAP 
{
    ...
    static void SET_BLIP_NAME_FROM_TEXT_FILE(Blip blip, char* gxtEntry) { return Native::Invoke<void, Blip, char*>(0x0A062D6D7C0B2C2C, blip, gxtEntry); } 
...
namespace MISC 
{
    ...
    static Hash GET_HASH_KEY(char* string) { return Native::Invoke<Hash, char*>(0xFD340785ADF8CFB7, string); } 
    ...
    static int COMPARE_STRINGS(char* str1, char* str2, BOOL matchCase, int maxLength) { return Native::Invoke<int, char*, char*, BOOL, int>(0xBFBB74A15EFC149B, str1, str2, matchCase, maxLength); } 
    ...
    static BOOL IS_STRING_NULL(char* string) { return Native::Invoke<BOOL, char*>(0x602102324604D96B, string); } 
    static BOOL IS_STRING_NULL_OR_EMPTY(char* string) { return Native::Invoke<BOOL, char*>(0x2CF12F9ACF18F048, string); } 
    static Any _0x375F5870A7B8BEC1(Any p0) { return Native::Invoke<Any, Any>(0x375F5870A7B8BEC1, p0); } 
    static BOOL ARE_STRINGS_EQUAL(char* string1, char* string2) { return Native::Invoke<BOOL, char*, char*>(0xD3852F22AB713A1F, string1, string2); } 
    ...
    static Any _CREATE_VAR_STRING(Any p0, Any p1, Any p2) { return Native::Invoke<Any, Any, Any, Any>(0xFA925AC00EB830B9, p0, p1, p2); } 
    ...
    static void DISPLAY_ONSCREEN_KEYBOARD(int p0, char* windowTitle, char* p2, char* defaultText, char* defaultConcat1, char* defaultConcat2, char* defaultConcat3, int maxInputLength) { return Native::Invoke<void, int, char*, char*, char*, char*, char*, char*, int>(0x044131118D8DB3CD, p0, windowTitle, p2, defaultText, defaultConcat1, defaultConcat2, defaultConcat3, maxInputLength); } 
    static int UPDATE_ONSCREEN_KEYBOARD() { return Native::Invoke<int>(0x37DF360F235A3893); } 
    static char* GET_ONSCREEN_KEYBOARD_RESULT() { return Native::Invoke<char*>(0xAFB4CF58A4A292B1); } 
...
namespace NETWORK 
{
    ...
    static BOOL NETWORK_IS_SCRIPT_ACTIVE(char* scriptName, int instanceId, BOOL unk, int positionHash) { return Native::Invoke<BOOL, char*, int, BOOL, int>(0x9D40DF90FAD26098, scriptName, instanceId, unk, positionHash); } 
    ...
    static char* NETWORK_GET_GAMERTAG_FROM_HANDLE() { return Native::Invoke<char*>(0x426141162EBE5CDB); } 
    ...
    static int TEXTURE_DOWNLOAD_REQUEST(int* PlayerHandle, char* FilePath, char* Name, BOOL p3) { return Native::Invoke<int, int*, char*, char*, BOOL>(0x16160DA74A8E74A2, PlayerHandle, FilePath, Name, p3); } 
    ...
    static char* TEXTURE_DOWNLOAD_GET_NAME(int p0) { return Native::Invoke<char*, int>(0x3448505B6E35262D, p0); } 
...
namespace PED 
{
    ...
    static void SET_PED_STEALTH_MOVEMENT(Ped ped, BOOL p1, char* action, Any p3) { return Native::Invoke<void, Ped, BOOL, char*, Any>(0x88CBB5CEB96B7BD2, ped, p1, action, p3); } 
    ...
    static Any ADD_RELATIONSHIP_GROUP(char* name, Hash* groupHash) { return Native::Invoke<Any, char*, Hash*>(0xF372BC22FCB88606, name, groupHash); } 
    ...
    static void SET_PED_GESTURE_GROUP(Ped ped, char* animGroupGesture, Any p2) { return Native::Invoke<void, Ped, char*, Any>(0xDDF803377F94AAA8, ped, animGroupGesture, p2); } 
    ...
    static Vector3 GET_ANIM_INITIAL_OFFSET_POSITION(char* animDict, char* animName, float x, float y, float z, float xRot, float yRot, float zRot, float p8, int p9) { return Native::Invoke<Vector3, char*, char*, float, float, float, float, float, float, float, int>(0xBE22B26DD764C040, animDict, animName, x, y, z, xRot, yRot, zRot, p8, p9); } 
    static Vector3 GET_ANIM_INITIAL_OFFSET_ROTATION(char* animDict, char* animName, float x, float y, float z, float xRot, float yRot, float zRot, float p8, int p9) { return Native::Invoke<Vector3, char*, char*, float, float, float, float, float, float, float, int>(0x4B805E6046EE9E47, animDict, animName, x, y, z, xRot, yRot, zRot, p8, p9); } 
    ...
    static void SET_PED_NAME_DEBUG(Ped ped, char* name) { return Native::Invoke<void, Ped, char*>(0x98EFA132A4117BE1, ped, name); } 
    ...
    static void APPLY_PED_BLOOD_SPECIFIC(Ped ped, Any p1, float xOffset, float yOffset, float zOffset, float scale, Any p6, float p7, char* bloodType) { return Native::Invoke<void, Ped, Any, float, float, float, float, Any, float, char*>(0xEF0D582CBF2D9B0F, ped, p1, xOffset, yOffset, zOffset, scale, p6, p7, bloodType); } 
    ...
    static void APPLY_PED_DAMAGE_PACK(Ped ped, char* damagePack, float damage, float mult) { return Native::Invoke<void, Ped, char*, float, float>(0x46DF918788CB093F, ped, damagePack, damage, mult); } 
    ...
    static void CLEAR_PED_DAMAGE_DECAL_BY_ZONE(Ped ped, int p1, char* p2) { return Native::Invoke<void, Ped, int, char*>(0x523C79AEEFCC4A2A, ped, p1, p2); } 
    ...
    static void SET_FACIAL_IDLE_ANIM_OVERRIDE(Ped ped, char* animName, char* animDict) { return Native::Invoke<void, Ped, char*, char*>(0xFFC24B988B938B38, ped, animName, animDict); } 
    ...
    static void SET_PED_USING_ACTION_MODE(Ped ped, BOOL p1, Any p2, char* action) { return Native::Invoke<void, Ped, BOOL, Any, char*>(0xD75ACCF5E0FB5367, ped, p1, p2, action); } 
    ...
    static void _SET_PED_PROMPT_NAME(Ped ped, const char* name) { return Native::Invoke<void, Ped, const char*>(0x4A48B6E03BABB4AC, ped, name); } 
...
namespace PLAYER 
{
    ...
    static char* GET_PLAYER_NAME(float player) { return Native::Invoke<char*, float>(0x7124FD9AC0E01BA0, player); } 
    ...
    static void FORCE_CLEANUP_FOR_ALL_THREADS_WITH_THIS_NAME(char* name, int cleanupFlags) { return Native::Invoke<void, char*, int>(0xDAACAF8B687F2353, name, cleanupFlags); } 
...
namespace SCRIPTS 
{
    ...
    static void REQUEST_SCRIPT(char* scriptName) { return Native::Invoke<void, char*>(0x46ED607DDD40D7FE, scriptName); } 
    static void SET_SCRIPT_AS_NO_LONGER_NEEDED(char* scriptName) { return Native::Invoke<void, char*>(0x0086D3067E1CFD1C, scriptName); } 
    static BOOL HAS_SCRIPT_LOADED(char* scriptName) { return Native::Invoke<BOOL, char*>(0xE97BD36574F8B0A6, scriptName); } 
    static BOOL DOES_SCRIPT_EXIST(char* scriptName) { return Native::Invoke<BOOL, char*>(0x552B171E3F69E5AE, scriptName); } 
...
namespace SOCIALCLUB 
{
    ...
    static char* _SC_INBOX_MESSAGE_GET_STRING() { return Native::Invoke<char*>(0x176D077685CD83E4); } 
...
namespace STREAMING 
{
    ...
    static BOOL DOES_ANIM_DICT_EXIST(char* animDict) { return Native::Invoke<BOOL, char*>(0x537F44CB0D7F150D, animDict); } 
    static void REQUEST_ANIM_DICT(char* animDict) { return Native::Invoke<void, char*>(0xA862A2AD321F94B4, animDict); } 
    static BOOL HAS_ANIM_DICT_LOADED(char* animDict) { return Native::Invoke<BOOL, char*>(0x27FF6FE8009B40CA, animDict); } 
    static void REMOVE_ANIM_DICT(char* animDict) { return Native::Invoke<void, char*>(0x4763145053A33D46, animDict); } 
    ...
    static void REQUEST_CLIP_SET(char* clipSet) { return Native::Invoke<void, char*>(0xEF7611B57A820126, clipSet); } 
    static BOOL HAS_CLIP_SET_LOADED(char* clipSet) { return Native::Invoke<BOOL, char*>(0x1F23D6B6DA1CC3B2, clipSet); } 
    static void REMOVE_CLIP_SET(char* clipSet) { return Native::Invoke<void, char*>(0x817FA1B1EE7CD6F0, clipSet); } 
    ...
    static void REQUEST_NAMED_PTFX_ASSET(char* assetName) { return Native::Invoke<void, char*>(0xF2B2353BBC0D4E8F, assetName); } 
    static BOOL HAS_NAMED_PTFX_ASSET_LOADED(char* assetName) { return Native::Invoke<BOOL, char*>(0x65BB72F29138F5D6, assetName); } 
    ...
    static void PREFETCH_SRL(char* srl) { return Native::Invoke<void, char*>(0x354837E5A5BAA5AF, srl); } 
...
namespace TASK 
{
    ...
    static void STOP_ANIM_TASK(Ped ped, char* animDictionary, char* animationName, float p3) { return Native::Invoke<void, Ped, char*, char*, float>(0x97FF36A1D40EA00A, ped, animDictionary, animationName, p3); } 
    ...
    static void TASK_STAND_GUARD(Ped ped, float x, float y, float z, float heading, char* scenarioName) { return Native::Invoke<void, Ped, float, float, float, float, char*>(0xAE032F8BBA959E90, ped, x, y, z, heading, scenarioName); } 
    ...
    static void PLAY_ANIM_ON_RUNNING_SCENARIO(Ped ped, char* animDict, char* animName) { return Native::Invoke<void, Ped, char*, char*>(0x748040460F8DF5DC, ped, animDict, animName); } 
    ...
    static BOOL DOES_SCENARIO_GROUP_EXIST(char* scenarioGroup) { return Native::Invoke<BOOL, char*>(0xF9034C136C9E00D3, scenarioGroup); } 
    static Any _0x76E98B52369A289C(Any p0) { return Native::Invoke<Any, Any>(0x76E98B52369A289C, p0); } 
    static BOOL IS_SCENARIO_GROUP_ENABLED(char* scenarioGroup) { return Native::Invoke<BOOL, char*>(0x367A09DED4E05B99, scenarioGroup); } 
    static Any _0xDCC374913DE6AAA6(Any p0) { return Native::Invoke<Any, Any>(0xDCC374913DE6AAA6, p0); } 
    static void SET_SCENARIO_GROUP_ENABLED(char* scenarioGroup, BOOL p1) { return Native::Invoke<void, char*, BOOL>(0x02C8E5B49848664E, scenarioGroup, p1); } 
    ...
    static BOOL IS_SCENARIO_TYPE_ENABLED(char* scenarioType) { return Native::Invoke<BOOL, char*>(0x3A815DB3EA088722, scenarioType); } 
    static void SET_SCENARIO_TYPE_ENABLED(char* scenarioType, BOOL toggle) { return Native::Invoke<void, char*, BOOL>(0xEB47EC4E34FB7EE1, scenarioType, toggle); } 
    ...
    static void OPEN_PATROL_ROUTE(char* patrolRoute) { return Native::Invoke<void, char*>(0xA36BFB5EE89F3D82, patrolRoute); } 
    static void CLOSE_PATROL_ROUTE() { return Native::Invoke<void>(0xB043ECA801B8CBC1); } 
    static void ADD_PATROL_ROUTE_NODE(int p0, char* p1, float x1, float y1, float z1, float x2, float y2, float z2, int p8, Any p9) { return Native::Invoke<void, int, char*, float, float, float, float, float, float, int, Any>(0x8EDF950167586B7C, p0, p1, x1, y1, z1, x2, y2, z2, p8, p9); } 
    ...
    static void DELETE_PATROL_ROUTE(char* patrolRoute) { return Native::Invoke<void, char*>(0x7767DD9D65E91319, patrolRoute); } 
    static Any _0x643FD1556F621772(Any p0, Any p1, Any p2) { return Native::Invoke<Any, Any, Any, Any>(0x643FD1556F621772, p0, p1, p2); } 
    static void TASK_PATROL(Ped ped, char* p1, Any p2, BOOL p3, BOOL p4) { return Native::Invoke<void, Ped, char*, Any, BOOL, BOOL>(0xBDA5DF49D080FE4E, ped, p1, p2, p3, p4); } 
    ...
    static void REQUEST_WAYPOINT_RECORDING(char* name) { return Native::Invoke<void, char*>(0x9EEFB62EB27B5792, name); } 
    static BOOL GET_IS_WAYPOINT_RECORDING_LOADED(char* name) { return Native::Invoke<BOOL, char*>(0xCB4E8BE8A0063C5D, name); } 
    static void REMOVE_WAYPOINT_RECORDING(char* name) { return Native::Invoke<void, char*>(0xFF1B8B4AA1C25DC8, name); } 
    static Any _0xF718931A82EEB898() { return Native::Invoke<Any>(0xF718931A82EEB898); } 
    static BOOL WAYPOINT_RECORDING_GET_NUM_POINTS(char* name, int* points) { return Native::Invoke<BOOL, char*, int*>(0x5343532C01A07234, name, points); } 
    static BOOL WAYPOINT_RECORDING_GET_COORD(char* name, int point, Vector3* coord) { return Native::Invoke<BOOL, char*, int, Vector3*>(0x2FB897405C90B361, name, point, coord); } 
    static float WAYPOINT_RECORDING_GET_SPEED_AT_POINT(char* name, int point) { return Native::Invoke<float, char*, int>(0x005622AEBC33ACA9, name, point); } 
    static BOOL WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(char* name, float x, float y, float z, int* point) { return Native::Invoke<BOOL, char*, float, float, float, int*>(0xB629A298081F876F, name, x, y, z, point); } 
    ...
    static float GET_WAYPOINT_DISTANCE_ALONG_ROUTE(char* p0, int p1) { return Native::Invoke<float, char*, int>(0xA5B769058763E497, p0, p1); } 
    ...
    static void ASSISTED_MOVEMENT_REMOVE_ROUTE(char* route) { return Native::Invoke<void, char*>(0x3548536485DD792B, route); } 
    ...
    static BOOL ASSISTED_MOVEMENT_IS_ROUTE_LOADED(char* route) { return Native::Invoke<BOOL, char*>(0x60F9A4393A21F741, route); } 
    static void ASSISTED_MOVEMENT_SET_ROUTE_PROPERTIES(char* route, int props) { return Native::Invoke<void, char*, int>(0xD5002D78B7162E1B, route, props); } 
    ...
    static void TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Ped ped, Vehicle vehicle, char* WPRecording, int p3, int p4, int p5, int p6, float p7, BOOL p8, float p9, Any p10) { return Native::Invoke<void, Ped, Vehicle, char*, int, int, int, int, float, BOOL, float, Any>(0x3123FAA6DB1CF7ED, ped, vehicle, WPRecording, p3, p4, p5, p6, p7, p8, p9, p10); } 
...
namespace TXD 
{
    ...
    static void REQUEST_STREAMED_TEXTURE_DICT(char* textureDict, BOOL unused) { return Native::Invoke<void, char*, BOOL>(0xC1BA29DF5631B0F8, textureDict, unused); } 
    static BOOL HAS_STREAMED_TEXTURE_DICT_LOADED(char* textureDict) { return Native::Invoke<BOOL, char*>(0x54D6900929CCF162, textureDict); } 
    static void SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED(char* textureDict) { return Native::Invoke<void, char*>(0x4ACA10A91F66F1E2, textureDict); } 
}
namespace UIAPPS 
{
...
namespace VEHICLE 
{
    ...
    static void REQUEST_VEHICLE_RECORDING(int i, char* name) { return Native::Invoke<void, int, char*>(0xC474CF16EDA45DC9, i, name); } 
    ...
    static Vector3 GET_POSITION_OF_VEHICLE_RECORDING_AT_TIME(int p0, float p1, char* p2) { return Native::Invoke<Vector3, int, float, char*>(0x1A00961A1BE94E5E, p0, p1, p2); } 
    ...
    static void START_PLAYBACK_RECORDED_VEHICLE(Vehicle vehicle, int p1, char* playback, BOOL p3) { return Native::Invoke<void, Vehicle, int, char*, BOOL>(0x4932B84E3276508E, vehicle, p1, playback, p3); } 
